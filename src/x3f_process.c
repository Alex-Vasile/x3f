...
#define RIGHT 3
     ...
     * */
    {
        ...
        if (!strcmp(cammodel, "SIGMA DP1 Merrill") || !strcmp(cammodel, "SIGMA DP2 Merrill") ||
...
static void interpolate_bad_pixels(x3f_t *x3f, x3f_area16_t *image, int colors)
{
    ...
    if (colors == 3) {
        ...
        /* TODO: should those really be interpolated over, or should they be rescaled instead? */
